        ...
        <table>
          ...
          <tbody>
            <tr v-for="vehiculo in listadoVehiculos" :key="vehiculo.id">
              ...
              <td>
                <router-link v-if="vehiculo.estado === 'Disponible'" :to="{
                  path: '/rentar',
                  query: {
                    id: vehiculo.id,
                ...
                <p v-else class="error-message">No disponible</p>
              </td>
            </tr>
          </tbody>
        </table>
...
<script>
import { consultarVehiculoPorMarcaYModeloFachada } from "@/clients/clienteCliente";
